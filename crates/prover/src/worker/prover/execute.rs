...
use sp1_core_executor::{
    ...
    SP1RecursionProof, PUBLIC_VALUE_DIGEST_WORDS,
};
...
fn public_value_digest_from_words(words: &[u32; PUBLIC_VALUE_DIGEST_WORDS]) -> [u8; 32] {
...
pub async fn execute_with_options(
    ...
    enum ExecutorOutput {
        ...
        PublicValues {
            ...
            public_value_digest_words: [u32; PUBLIC_VALUE_DIGEST_WORDS],
